                ...
                Promise.all([workshopsResponse.json(), archiveResponse.json()]).then(
                    ...
                    .then(() => {
                        if (navigator.cookieEnabled) {
                            ...
                            const prevFilterWorkshopToggle = sessionStorage.getItem("prevFilterWorkshopToggle")
                            const prevFilterArchiveToggle = sessionStorage.getItem("prevFilterArchiveToggle")
                            if (prevFilterCrafts) {
