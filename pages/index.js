          ...
          <div className="container-text">
            ...
            <ScrollPage page={0}>
              ...
              <div className="container-sm vh-100 mt-5 p-4 pt-5">
                ...
                <ImageFilter className="d-inline-block align-bottom col-2 col-md-1 m-1 m-sm-2 collage"
                             filter={"duotone"}
                ...
                />
                <ImageFilter className="d-inline-block align-bottom col-3 col-md-2 m-1 m-sm-2 collage"
                             filter={"duotone"}
                ...
                <ImageFilter className="d-inline-block align-middle align-sm-middle col-3 col-sm-2 m-1 m-sm-2 collage"
                             filter={"duotone"}
                             ...
                             colorTwo={duotoneCraft.default.two}
                />
                <ImageFilter className="d-inline-block align-bottom col-6 col-sm-5 col-md-3 col-lg-4 m-1 m-sm-2 collage"
                             filter={"duotone"}
                ...
                <ImageFilter className="d-inline-block align-bottom col-2 col-md-1 m-1 m-sm-2 collage"
                             ...
                             colorTwo={duotoneCraft.default.two}
                />
                <ImageFilter className="d-inline-block align-top col-4 col-md-2 m-1 m-sm-2 ms-4 collage"
                             filter={"duotone"}
                             ...
                             colorTwo={duotoneCraft.default.two}
                />
                <ImageFilter className="d-inline-block align-middle col-6 col-md-4 col-lg-5 m-1 m-sm-2 collage"
                             filter={"duotone"}
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="nav-item col-7 col-sm-5 col-md-4 col-lg-3">
                      <a href="/map">
                        ...
                        <p className="mb-0 lh-1">{t("the spatial presence of craftsmanship in Beirut")}</p>
                      </a>
                    </div>
                  </div>
                  <div className="row mb-3">
                    ...
                    <div className="nav-item col-7 col-sm-5 col-md-4 col-lg-3">
                      <a href="/discover">
                        ...
                        <p className="mb-0 lh-1">current craft workshops and archival images of Beirut's
                          craftsmanship</p>
                      </a>
                    </div>
                  </div>
                  <div className="row mb-3">
                    ...
                    <div className="nav-item col-7 col-sm-5 col-md-4 col-lg-3">
                      <a href="/contribute">
                        ...
                        {i18n.language==="en"?<p className="mb-0 lh-1">to the <em>Living Heritage Atlas</em> with photos of Beirut's
                          craftsmanship</p>:<p className="mb-0 lh-1">{t("to the Living Heritage Atlas with photos of craftsmanship")}</p>}
                      </a>
                    </div>
                  </div>
                  <div className="row mb-3">
                    ...
                    <div className="nav-item col-7 col-sm-5 col-md-4 col-lg-3">
                      <a href="/download">
                        ...
                        <p className="mb-0 lh-1">craft workshop and archival image data from the <em>Living Heritage
                          Atlas</em></p>
                      </a>
                    </div>
                  </div>
