        ...
        <div className="about-card col col-md-10 col-lg-8">
          ...
          <div className="t-event container-fluid mt-4">
            <div className="row mb-2">
              <div className="col-12 col-sm-3 col-md-2 px-0 pb-2"><b>Pre-Opening</b></div>
            ...
            <div className="row mb-2">
              <div className="col-12 col-sm-3 col-md-2 px-0 pb-2"><b>Opening Remarks</b><br/>6:00&ndash;6:30pm</div>
              <div className="col-12 col-sm-9 col-md-10 px-0 px-sm-3">
            ...
            <div className="row mb-2">
              <div className="col-12 col-sm-3 col-md-2 px-0 pb-2"><b>Mapping Methods Discussion</b><br/>6:30&ndash;7:00pm</div>
              <div className="col-12 col-sm-9 col-md-10 px-0 px-sm-3">
                ...
                <ol className={`groups ` + i18n.language}>
                  ...
                  <li>
                    <b>Mobilizing Crafts in Shared Spaces</b><br/>
            ...
            <div className="row mb-2">
              <div className="col-12 col-sm-3 col-md-2 px-0 pb-2 mb-sm-1"><b>Break</b><br/>7:00&ndash;7:15pm</div>
              <div className="col-12 col-sm-9 col-md-10 px-0 px-sm-3">
            ...
            <div className="row mb-2">
              <div className="col-12 col-sm-3 col-md-2 px-0 pb-2"><b>Closing Remarks</b><br/>7:45&ndash;8:00pm</div>
              <div className="col-12 col-sm-9 col-md-10 px-0 px-sm-3">
