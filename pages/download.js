      ...
      <div className="container">
        ...
        <div className="download-card">
          <div className="mb-5">
            ...
            <p>The <em>Living Heritage Atlas | Beirut</em> has conducted multiple data collection initiatives through interviews, desk-research, archivla research, and surveys in the field. The data collected by our team includes personal photos from craftspeople, visual material collected from libraries and private collections, and inputs received through our crowdsourcing platform, where users are invited to <a href="/contribute">contribute to this database</a>. The <em>Living Heritage Atlas | Beirut</em> is a unique dataset which includes:
              </p>
            <ul>
          ...
          <div className="mb-5">
            ...
            <p>Images from <em>Living Heritage Atlas | Beirut</em> are not currently available for download, but we plan to make these available in the near future. Stay tuned for more information soon!</p>
          </div>
        </div>
      </div>
    </>
