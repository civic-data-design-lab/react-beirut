        ...
        <div className="download-card">
          <div className="mb-5">
            ...
            <ul>
              ...
              <li>
                {t("100+ location points of 100+ craftspeoples' workshops")}
              </li>
          ...
          <div className="mb-5">
            ...
            <p>
              <b>{t('Suggested citation:')}</b>
              <br />
              MIT Civic Data Design Lab, Future Heritage Lab.{' '}
              <em>Living Heritage Atlas | Beirut: Archival Information</em>.
          ...
          <div className="mb-5">
            <h3>
              <b>{t('Archival Information Data')}</b>
            </h3>
            <p>
              {t(
          ...
          <div className="mb-5">
            <h3>
              <b>{t('Images and Image Metadata')}</b>
            </h3>
            <div className={'d-flex flex-row align-items-center'}>
              <a>
                <button className="btn-pill" onClick={getImages}>
                  {t('Download Images')}
                </button>
              </a>
            ...
            <a
              className={'h-0 w-0 opacity-0 d-none pe-none'}
