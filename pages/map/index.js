...
export default class Explore extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            allLayers: {
                ...
                3: ['1920', 'Armée Française du Levant. Bureau Topographique. (1920).  ', '67ffz8i7', [35.505290624632835, 33.88882411869989], 13.639303743791698, "Beirut", "(Trans.). Item GE C-5752, (82 x 57cm). National Library of France, Departments of Maps and Plans. Paris, France."],
                4: ['1945', 'Institut Géographique National. (1945). ', "1945_cropped", [35.50229661568903, 33.8893239106455], 13.739534370107044, "City of Beirut", " (Trans.). Item MAP G7474.B4 1945.I5, (53 x 72cm). Black and white reprint of the original map. MIT Rotch Library. Cambridge (MA), USA.', '1945_cropped"],
    ...
    toggleArchiveReset={this.state.toggleArchiveReset}
                    ...
                    <div className={'filterSection'}>
                        ...
                        <button className={'filterButton layerControlButton btn-interactivity'}
                    ...
                    {this.state.showLayersControl ?
                        <LayersControl currentLayer={this.state.mapLayer} allLayers={this.state.allLayers}
                                       ...
                                       closeLayersControl={this.closeLayersControl}/> : null}
