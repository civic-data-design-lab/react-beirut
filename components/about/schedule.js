    ...
    <>
      <Default>
        <div className="container-fluid">
          <div className="row">
            <div className="col-2 p-2 t-1">
              <b>{t('Date')}</b>
            </div>
            <div className="col-10">
              <div className="row">
                <div className="col-3 p-2 t-1">
                  <h6 class="mb-0">
                    <b>{t('Tuesday, July 5')}</b>
                  </h6>
                </div>
                <div className="col-lg-1 p-2 t-1">
                  <h6 class="mb-0">
                    <b>{t('Wed')}</b>
                  </h6>
                </div>
                <div className="col-6 col-lg-5 p-2 t-1">
                  <h6 class="mb-0">
                    <b>{t('Thursday, July 7')}</b>
                  </h6>
                </div>
                <div className="col-3 p-2 t-1">
                  <h6 class="mb-0">
            ...
            <div className="col-10">
              <div className="row">
                <div className="col-3 p-2 t-3">
                  <h6>
                    <b>{t('Crafts Workshops Tour')}</b>&ensp;|&ensp;
                    {t('Gemmayze - Mar Mikhael (Doniguian Armenian bookstore)')}
                  </h6>
                  <hr />
                  <p className="mb-0">
                    {t(
            ...
            <div className="col-10">
              <div className="row">
                <div className="col-3 p-2 t-5">
                  <h6>
                    <b>{t('Archival Workshops Tour')}</b>&ensp;|&ensp;
                    {t('Al Balad (Samir Kassir Square)')}
                  </h6>
                  <hr />
                  <p>
                    {t(
                ...
                <div className="col-6 col-lg-5 p-2 t-7">
                  <h6>
                    <b>{t('Living Heritage Atlas Event')}</b>{' '}
                    {t('(Abroyan Factory, Bourj Hammoud)')}
                  </h6>
                  <hr />
                  <ol className={i18n.language}>
                    <li>
                      {t('Opening remarks by MIT CDDL & FHL (6:00 - 6:30 PM)')}
                    </li>
                    <li>
                      {t(
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-9 p-2 t-3">
              <h6>
                <b>{t('Craft Workshops Tour')}</b>&ensp;|&ensp;{t('Gemmayze')}
                &ndash;{t('Mar Mikhael')}
              </h6>
              <hr />
              <p className="mb-0">
          ...
          <div className="row">
            ...
            <div className="col-9 p-2 t-5">
              <h6>
                <b>{t('Archival Crafts Tour')}</b>&ensp;|&ensp;{t('Al Balad')}
              </h6>
              <hr />
              <p>
                {t(
                  'Walking tour of locations of old craft workshops and souks in Al Balad'
                )}
              </p>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-9 p-2 t-3">
              <h6>
                <b>{t('Craft Workshops Tour')}</b>&ensp;|&ensp;
                {t('Bourj Hammoud')}
              </h6>
              <hr />
              <p className="mb-0">
          ...
          <div className="row">
            ...
            <div className="col-9 p-2 t-5">
              <h6>
                <b>{t('Archival Crafts Tour')}</b>&ensp;|&ensp;
                {t('Bourj Hammoud')}
              </h6>
              <hr />
              <p>
                {t(
                  'Walking tour of locations of old craft workshops and souks in Bourj Hammoud'
                )}
              </p>
            </div>
          </div>
