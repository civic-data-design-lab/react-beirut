    ...
    <>
      ...
      >
        <div className={'nav-parent-container container'}>
          <div className={'nav-left-container'}>
            ...
            {getPath() && width > 590 ? (
              <div
                className={`nav-divider vr ${
                  isMenuOpen ? ' hide-background' : ''
                }`}
              />
            ) : null}
      ...
      <div id="menu" className={isMenuOpen ? 'open' : ''}>
        <nav className="main-nav">
          <div
            className="justify-content-center d-flex container-links"
            style={{ margin: 'auto' }}
          >
            <ul>
              <li
              ...
              >
                <div className="container">
                  ...
                  <div className="item-text-2">
                    {' '}
                    {t('data from the Living Heritage Atlas')}{' '}
                  </div>
                </div>
              </li>
              <li
              ...
              >
                <div className="container">
                  ...
                  <div className="item-text-2">
                    {' '}
                    {t('the Living Heritage Atlas | Beirut')}{' '}
                  </div>
                </div>
              </li>
            </ul>
