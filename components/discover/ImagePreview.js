...
const ImagePreview = ({
  ...
  const imgDuotone =
    workshop.craft_discipline_category.length == 1
      ? duotoneCraft[workshop.craft_discipline_category[0]]
      : workshop.craft_discipline_category.length == 2
      ? {
          one: duotoneCraft[workshop.craft_discipline_category[0]].one,
          two: duotoneCraft[workshop.craft_discipline_category[1]].two,
        }
