...
const convertWorkshopContributionToSchema = (data) => {
  ...
  // INFO: Craft disciplines
  // TODO: @GatlenCulp - Update this if your craft type implementation changes
...
const convertArchiveContributionToSchema = (data) => {
  ...
  // INFO: Format the craft disciplines data
