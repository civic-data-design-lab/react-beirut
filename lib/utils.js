...
const convertArchiveContributionToSchema = (data, formSchema) => {
  ...
  // INFO: get craft types and craft other types
  let craft_discipline = _separateOtherCrafts(data[imagePage.fields.type_of_craft.field_name], false);
  let craft_discipline_other = _separateOtherCrafts(data[imagePage.fields.type_of_craft.field_name], true)
