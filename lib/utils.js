...
const _getLocationFromForm = (data) => {
    ...
    console.log("location notes is ", data.location_notes)
    let address = null;
...
const _getImageDataFromWorkshopForm = (data, id) => {
    if (Object.keys(data.images).length < 1) return;
...
const convertWorkshopContributionToSchema = (data, formSchema) => {
    ...
    console.log(`this is what the consent value is ${data[previewPage.fields.consent.field_name]}`)
     ...
     */
    let {imageIds, imageMetas, imageDataOriginals} = _getImageDataFromWorkshopForm(
        data,
        newWorkshopId
    );
    ...
    const workshop = {
        ...
        contact_info: {
            ...
            other_social_media: data[aboutPage.fields.other_social_media.field_name] || null,
        },
        craft_discipline_category: data[aboutPage.fields.craft_category.field_name].map((category) => {
...
const convertArchiveContributionToSchema = (data, formSchema) => {
    ...
    const {imageIds, imageMetas, imageDataOriginals} = _getImageDataFromArchiveForm(
        data,
        newArchiveId
    );
    ...
    const archive = {
        ...
        craft_discipline_category: data[imagePage.fields.craft_category.field_name].map((category) => {
            return category.toLowerCase()
        }),
        craft_discipline: craftDiscipline,
    ...
    "resources": {
        "en": {
            "translation": {
                ...
                "Two-hour roundtable discussion and mapping event": "Two-hour roundtable discussion and mapping event",
                "Date&#58;": "Date:",
                ...
                "Register to attend Living Heritage Atlas | ;Beirut events via the ": "Register to attend Living Heritage Atlas | Beirut events via the ",
                "Date": "Date",
        ...
        "ar": {
            "translation": {
                ...
                "Street view of ": "\u0645\u0638\u0647\u0631 X \u0645\u0646 \u0627\u0644\u0634\u0627\u0631\u0639 ",
                ...
                "It constructs a digital archive of geolocated historic data and images using visual and textual materials from local archives, residents, and craftspeople. Data is open-access and available to download at:": "\u064a\u0646\u0634\u0626 \u0623\u0631\u0634\u064a\u0641\u064b\u0627 \u0631\u0642\u0645\u064a\u064b\u0627 \u0644\u0644\u0628\u064a\u0627\u0646\u0627\u062a \u0648\u0627\u0644\u0635\u0648\u0631 \u0627\u0644\u062a\u0627\u0631\u064a\u062e\u064a\u0629 \u0627\u0644\u0645\u062d\u062f\u062f\u0629 \u062c\u063a\u0631\u0627\u0641\u064a\u064b\u0627 \u0628\u0627\u0633\u062a\u062e\u062f\u0627\u0645 \u0627\u0644\u0645\u0648\u0627\u062f \u0627\u0644\u0645\u0631\u0626\u064a\u0629 \u0648\u0627\u0644\u0646\u0635\u064a\u0629 \u0645\u0646 \u0627\u0644\u0645\u062d\u0641\u0648\u0638\u0627\u062a \u0627\u0644\u0645\u062d\u0644\u064a\u0629 \u0648\u0627\u0644\u0645\u0642\u064a\u0645\u064a\u0646 \u0648\u0627\u0644\u062d\u0631\u0641\u064a\u064a\u0646. \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a \u0645\u0641\u062a\u0648\u062d\u0629 \u0627\u0644\u0648\u0635\u0648\u0644 \u0648\u0645\u062a\u0627\u062d\u0629 \u0644\u0644\u062a\u0646\u0632\u064a\u0644 \u0639\u0644\u0649: ",
                ...
                "Living Heritage Atlas Event": "\u0623\u0637\u0644\u0633 \u0627\u0644\u062a\u0631\u0627\u062b \u0627\u0644\u062d\u064a \u0627\u0644\u062d\u062f\u062b",
                "(Abroyan Factory, Bourj Hammoud)": "(\u0645\u0635\u0646\u0639 \u0627\u0628\u0631\u0648\u064a\u0627\u0646 \u060c \u0628\u0631\u062c \u062d\u0645\u0648\u062f)",
                "Opening remarks by MIT CDDL & FHL (6:00 - 6:30 PM)": "\u0645\u0644\u0627\u062d\u0638\u0627\u062a \u0627\u0641\u062a\u062a\u0627\u062d\u064a\u0629 \u0645\u0646 MIT CDDL & FHL (\u0666:\u0660\u0660 - \u0666:\u0663\u0660 \u0645\u0633\u0627\u0621\u064b)",
                "Mapping methods, 3 roundtable discussions (6:30 - 7:45 PM)": "\u0662. \u0637\u0631\u0642 \u0627\u0644\u0645\u0633\u062d \u060c \u0663 \u0645\u0646\u0627\u0642\u0634\u0627\u062a (\u0666:\u0663\u0660 - \u0667:\u0664\u0665 \u0645\u0633\u0627\u0621\u064b)",
                "Mapathon (8:00 - 9:00 PM)": "\u0663. \u0645\u0627\u0628\u0627\u062b\u0648\u0646 (\u0668:\u0660\u0660 - \u0669:\u0660\u0660 \u0645\u0633\u0627\u0621\u064b)",
                "Closing remarks (9:00 - 9:15 PM)": "\u0664. \u0645\u0644\u0627\u062d\u0638\u0627\u062a \u062e\u062a\u0627\u0645\u064a\u0629 (\u0669:\u0660\u0660 - \u0669:\u0661\u0665 \u0645\u0633\u0627\u0621\u064b)",
                ...
                "We invite you to download data from the Living Heritage Atlas to use this data responsibly.": "ندعوكم لتنزيل البيانات من أطلس التراث الحي لاستخدامها بشكل مسؤول.",
                "Craftspeople have a historic role in perpetuating cultural practices in the city through their products and workshop spaces that are sites of socializing, learning, and commerce. However, they are marginalized in every reconstruction of the city and its subsequent gentrification. Our team believes that their movements and their workshops tell key stores on the urban development of Beirut that are worth uncovering.": "يلعب الحرفيون دورًا تاريخيًا في إدامة الممارسات الثقافية في المدينة من خلال منتجاتهم ومساحات ورش العمل التي تعتبر مواقع للتواصل الاجتماعي والتعلم والتجارة. ومع ذلك ، يتم تهميشهم في كل إعادة بناء للمدينة وترميمها اللاحق. يعتقد فريقنا أن تحركاتهم وورش عملهم تخبر المتاجر الرئيسية عن التطور الحضري لبيروت التي تستحق الكشف عنها.",
                "The Living Heritage Atlas | Beirut has conducted multiple data collection initiatives through interviews, desk-research, archivla research, and surveys in the field. The data collected by our team includes personal photos from craftspeople, visual material collected from libraries and private collections, and inputs received through our crowdsourcing platform, where users are invited to contribute to this database. The Living Heritage Atlas | Beirut is a unique dataset which includes:": "أطلس التراث الحي | بيروت أقام بمبادرات متعددة لجمع البيانات من خلال المقابلات ، والبحوث المكتبية ، وأبحاث الأرشيف ، والاستطلاعات الميدانية. تتضمن البيانات التي يجمعها فريقنا صورًا شخصية من حرفيين ، ومواد مرئية تم جمعها من المكتبات والمجموعات الخاصة ، والمدخلات الواردة من خلال منصة التعهيد الجماعي الخاصة بنا ، حيث تتم دعوة المستخدمين للمساهمة في قاعدة البيانات هذه. أطلس التراث الحي | بيروت هي مجموعة بيانات فريدة تشمل:",
                "20+ interviews with local stakeholders, NGOs, government organizations, and international agencies who joined forces since the aftermath of the August 4th explosion in Beirut": "أكثر من ٢٠ مقابلة مع أصحاب المصلحة المحليين والمنظمات غير الحكومية والمنظمات الحكومية والوكالات الدولية الذين وحدوا قواهم منذ أعقاب انفجار 4 آب في بيروت",
                "100+ location points of 100+ craftspeoples' workshops": "أكثر من ١٠٠ نقطة موقع لأكثر من ١٠٠ ورشة عمل للحرفيين",
                "60+ survey responses from craftspeople": "أكثر من ٦٠ استجابات استقصائية من الحرفيين",
                "600+ archival entries (both textual and visual) on craft spaces and workshops between the early 20th Century to present day": "٦٠٠+ مدخلات أرشيفية (نصية ومرئية) في المساحات الحرفية وورش العمل بين أوائل القرن العشرين حتى يومنا هذا",
                "Craft Workshop Data": "بيانات ورشة العمل الحرفية",
                "This dataset contains publicly accessible information on current local craft workshops in Beirut. Data attributes available in this download include: location (latitude and longitude), craft type, operation status, decade of year established, and whether crafts are produced on site.": "تحتوي مجموعة البيانات هذه على معلومات يمكن  للجمهور الوصول إليها حول ورش العمل الحرفية المحلية الحالية في بيروت. تتضمن سمات البيانات المتوفرة في هذا التنزيل: الموقع (خطوط الطول والعرض) ، ونوع الحرفة ، وحالة العملية ، وعقد من العام ، وما إذا كان يتم إنتاج الحرف اليدوية في الموقع.",
                "Suggested citation:": "الاقتباس المقترح:",
                "This dataset contains information gathered from multi-site archival research on the presence of craftsmanship in Beirut over time. Data attributes available in this download include: location (latitude and longitude), craft type, image caption, image type, year photo taken, reference source": "تحتوي مجموعة البيانات هذه على معلومات تم جمعها من أبحاث أرشيفية متعددة المواقع حول وجود الحرف اليدوية في بيروت بمرور الوقت. تشمل سمات البيانات المتوفرة في هذا التنزيل: الموقع (خطوط الطول والعرض) ، ونوع الحرف ، وتعليق الصورة ، ونوع الصورة ، وسنة التقاط الصورة ، والمصدر المرجعي",
                "MIT Civic Data Design Lab, Future Heritage Lab. Living Heritage Atlas | Beirut: Archival Information. Massachusetts Institute of Technology, 2022.": " MIT مختبر تصميم البيانات المدنية،مختبر التراث المستقبلي. أطلس التراث الحي | بيروت: معلومات أرشيفية. معهد ماساتشوستس للتكنولوجيا، ٢٠٢٢.",
                ...
                "Images from Living Heritage Atlas | Beirut are not currently available for download, but we plan to make these available in the near future. Stay tuned for more information soon!": "صور من أطلس التراث الحي | بيروت غير متاحة حاليًا للتنزيل ، لكننا نخطط لإتاحتها في المستقبل القريب. ترقبوا المزيد من المعلومات قريبا!",
                "Submit": "إرسال",
                ...
                "Upload an image of the craft workshop": "قم بتحميل صورة لورشة العمل الحرفية",
                "Locate the craft workshop on the map. Please zoom in and move the pin to adjust for accuracy and to confirm that the pin is located correctly.": "حدد موقع الورشة الحرفية على الخريطة. يرجى التكبير وتحريك الإشارة لضبط الدقة وللتأكيد على أن الإشارة موجودة بشكل صحيح.",
                ...
                "options.": "الخيارات.",
                "You have already selected this tag from the default tags.": "لقد قمت بالفعل بإختيار هذا الوسم من الوسوم الافتراضية.",
                "Please select it from the default tags.": "يرجى الإختيار من الوسوم الافتراضية.",
                "Please enter a tag that is less than 50 characters.": " الرجاء إدخال وسم أقل من 50 حرفًا.",
                ...
                "Business contact information required": "معلومات الاتصال المهنية مطلوبة",
                "Craft Category": "فئة الحرفة",
                "Type of Craft": "نوع الحرفة",
                "Your custom tag was invalid.": "وسمك المخصص غير صالح.",
                "Please enter a tag that contains only letters.": "الرجاء إدخال وسم يحتوي على أحرف فقط.",
                ...
                "workshop": "ورشة",
                "Since": "منذ",
                "This archive image has been reviewed and verified.": "تمت مراجعة صورة الأرشيف هذه والتحقق منها.",
                "This archive image has not been reviewed and verified": "لم يتم مراجعة صورة الأرشيف هذه والتحقق منها.",
                "This crafts workshop has not been reviewed and verified": "لم يتم مراجعة هذه الورشة والتحقق منها",
                "This crafts workshop has been reviewed and verified": "تمت مراجعة ورشة العمل هذه والتحقق منها",
                "Two-hour roundtable discussion and mapping event": "مناقشة لمدة ساعتين وحدث المسح",
                "Abroyan Factor —Emile Eddeh Street, Bouj Hammoud, Beirut": "مصنع ابرويان - شارع اميل اده ، برج حمود ، بيروت",
                "We will begin with introductions; each participant will be given a tag based on their contribution to the event. Categories will include: expert, contributor, advocate, moderator, craftsperson, data collector.": "سنبدأ مع مقدمات. سيتم منح كل مشارك علامة بناءً على مساهمته في الحدث. ستشمل الفئات: خبير ، مساهم ، محامي ، وسيط ، حرفي ، جامع بيانات.",
                "MIT FHL & CDDL will kick-off the event with an opening presentation.": "سيبدأ مختبري MIT FHL & CDDL الحدث بعرض افتتاحي.",
                "We will divide into sub-groups to focus the discussion on three main topics: Documenting Craftsmanship, Legitimizing Craftspeople's Presence, and Mobilizing Crafts in Shared Spaces. Participants in each group will be asked to share their methods and to articulate different approaches to preserve living heritage. The moderator at each table will lead the discussion and report summarized findings at the end of the discussion. Experts will be guided to one of three tables based on their area of expertise. Discussion sub-groups:": "سنقسم إلى مجموعات فرعية لتركيز المناقشة على ثلاثة مواضيع رئيسية: توثيق الحرفية ، وإضفاء الشرعية على حضور الحرف اليدوية ، وتعبئة الحرف في الأماكن المشتركة. سيُطلب من المشاركين في كل مجموعة مشاركة أساليبهم والتعبير عن مناهج مختلفة للحفاظ على التراث الحي. سيقود المنسق في كل طاولة المناقشة ويبلغ النتائج الملخصة في نهاية المناقشة. سيتم إرشاد الخبراء إلى أحد الجداول الثلاثة بناءً على مجال خبرتهم. مجموعات المناقشة الفرعية:",
                "Data collectors will collect and scan your living heritage items.": "سيقوم جامعو البيانات بجمع وفحص عناصر التراث الحي الخاصة بك.",
                "View Map": "رؤية الخريطة",
                "View Images": "رؤية الصور",
                "Please upload images less than 4MB": "يرجى تحميل صور أقل من ٤ ميغا بايت"
