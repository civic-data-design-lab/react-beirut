...
export const saveNewWorkshop = async (data) => {
  ...
  console.log('calling saveNewWorkshop');

  console.log('data in api endpoint is ', data);
  ...
  try {
    ...
    console.log('trying to save workshop to database');
    const newWorkshop = new Workshop(data.workshop);
    savedWorkshop = await newWorkshop.save();
    console.log('saved workshop to database');
